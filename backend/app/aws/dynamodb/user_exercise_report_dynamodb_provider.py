...
class UserExerciseReportDynamodbProvider(BaseDynamodbProvider):
    def __init__(self, region, stage):
        super().__init__(f"grind-meter-{stage}-user-exercise-report")

    # def add(self, user_exercise_report: LiftExerciseReport, user_id: str):
    #     item_id = str(uuid.uuid4())
    #
    #     item = {
    #         "exercise_id-user_id": item_id,
    #         "day_timestamp":
    #     }
    #     try:
